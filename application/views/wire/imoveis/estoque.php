                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title text-center">Status do estoque</h4>

                            <ul class="list-inline widget-chart m-t-20 m-b-15 text-center">
                                <li class="list-inline-item">
                                    <h5>3</h5>
                                    <p class="text-muted">Total de imóveis a venda</p>
                                </li>
                                <li class="list-inline-item">
                                    <h5>1</h5>
                                    <p class="text-muted">Total de imóveis em construção</p>
                                </li>
                                <li class="list-inline-item">
                                    <h5>1</h5>
                                    <p class="text-muted">Obras canceladas</p>
                                </li>
                            </ul>
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body text-center">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">ADICIONAR IMÓVEL</button>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-warning">Em construção</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Ed. El Clamone - <a href="#">#146</a> </td>
                                    <td>São Paulo</td>
                                    <td>21/11/2019</td>
                                    <td>21/12/2019</td>
                                    <td><a href="#">Baixar</a></td>
                                    <td><span class="badge badge-secondary">Em visita</span></td>
                                    <td>
                                        <div style="display:flex;justify-content:space-between">
                                            <a href="#" title="Editar" class="btn btn-outline-warning" ><i class="mdi mdi-pencil-outline" ></i></a>
                                            <a href="#" title="Excluir" class="btn btn-outline-danger" ><i class="mdi mdi-close " ></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>21/12/2019</td>
                                    <td><a href="#">Baixar</a></td>
                                    <td><span class="badge badge-success">Disponivel</span></td>
                                    <td>
                                        <div style="display:flex;justify-content:space-between">
                                            <a href="#" title="Editar" class="btn btn-outline-warning" ><i class="mdi mdi-pencil-outline" ></i></a>
                                            <a href="#" title="Excluir" class="btn btn-outline-danger" ><i class="mdi mdi-close " ></i></a>
...
<?php $this->load->view('wire/estrutura/footer'); ?>
    ...
    <!--C3 Chart-->
    <script src="<? echo base_url('assets/plugins/d3/d3.min.js'); ?>"></script>
    <script src="<? echo base_url('assets/plugins/c3/c3.min.js'); ?>"></script>
    <script src="<? echo base_url('assets/pages/c3-chart-init.js'); ?>"></script> 
