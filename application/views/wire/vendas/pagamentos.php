                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title text-center">Status de pagamentos no mês</h4>

                            <ul class="list-inline widget-chart m-t-20 m-b-15 text-center">
                                <li class="list-inline-item">
                                    <h5>3554</h5>
                                    <p class="text-muted">Confirmados</p>
                                </li>
                                <li class="list-inline-item">
                                    <h5>5954</h5>
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body text-center">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">ADICIONAR PAGAMENTO</button>
                        </div>
