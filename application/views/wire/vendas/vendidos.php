                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title text-center">TOP 5 Cidades com mais vendas no mês</h4>

                            <ul class="list-inline widget-chart m-t-20 m-b-15 text-center">
                                <li class="list-inline-item">
                                    <h5>3554</h5>
                                    <p class="text-muted">Vendidos</p>
                                </li>
                                <li class="list-inline-item">
                                    <h5>5954</h5>
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body text-center">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">ADICIONAR VENDA</button>
                        </div>
...
<?php $this->load->view('wire/estrutura/footer'); ?>
    ...
    <script src="<?= base_url('assets/view/wire/vendas/vendidos.js'); ?>"></script> 
