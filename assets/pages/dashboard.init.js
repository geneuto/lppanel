    ...
    var Dashboard = function () {
      ...
      Dashboard.prototype.createLineChart1 = function(element, data, xkey, ykeys, labels, lineColors) {
        ...
        Dashboard.prototype.init = function () {
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Categoria A', 'Categoria B', 'Categoria C'], ['#fcbe2d', '#02c58d', '#30419b']);
  
            //creating donut chart
            var $donutData = [
                {label: "São Paulo", value: 12000},
                {label: "S J Campos", value: 3000},
                {label: "Campinas", value: 2000}
            ];
        ...
        this.createLineChart1('morris-line-example', $data1, 'y', ['a', 'b'], ['Piazza Monet', 'Eco Park'], ['#30419b', '#02c58d']);
